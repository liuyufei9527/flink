...
public class DynamicCEPITCase extends AbstractTestBase {
	...
	public void testSimplePatternCEP() throws Exception {
		...
		DataStream<String> result = CEP.dynamicPattern(input, dataStreamFromPattern(env, pattern)).flatSelect((p, o) -> {
	...
	public void testSimpleKeyedPatternCEP() throws Exception {
		...
		DataStream<String> result = CEP.dynamicPattern(input, dataStreamFromPattern(env, pattern)).select(p -> {
			StringBuilder builder = new StringBuilder();
	...
	public void testSimplePatternEventTime() throws Exception {
		...
		DataStream<String> result = CEP.dynamicPattern(input, dataStreamFromPattern(env, pattern)).select(
	...
	public void testSimplePatternWithSingleState() throws Exception {
		...
		DynamicPatternStream<Tuple2<Integer, Integer>> pStream = CEP.dynamicPattern(input, dataStreamFromPattern(env, pattern));
	...
	public void testProcessingTimeWithWindow() throws Exception {
		...
		DataStream<Integer> result = CEP.dynamicPattern(input, dataStreamFromPattern(env, pattern)).select(new PatternSelectFunction<Integer, Integer>() {
			@Override
	...
	public void testTimeoutHandling() throws Exception {
		...
		DataStream<Either<String, String>> result = CEP.dynamicPattern(input, dataStreamFromPattern(env, pattern)).select(
	...
	public void testSimpleOrFilterPatternCEP() throws Exception {
		...
		DataStream<String> result = CEP.dynamicPattern(input, dataStreamFromPattern(env, pattern)).select(new PatternSelectFunction<Event, String>() {
	...
	public void testSimplePatternEventTimeWithComparator() throws Exception {
		...
		DataStream<String> result = CEP.dynamicPattern(input, dataStreamFromPattern(env, pattern), comparator).select(
			new PatternSelectFunction<Event, String>() {
	...
	public void testSimpleAfterMatchSkip() throws Exception {
		...
		DynamicPatternStream<Tuple2<Integer, String>> pStream = CEP.dynamicPattern(input, dataStreamFromPattern(env, pattern));
	...
	public void testRichPatternFlatSelectFunction() throws Exception {
		...
		DataStream<String> result =
			CEP.dynamicPattern(input, dataStreamFromPattern(env, pattern)).flatSelect(new RichPatternFlatSelectFunction<Event, String>() {
	...
	public void testRichPatternSelectFunction() throws Exception {
		...
		DataStream<String> result = CEP.dynamicPattern(input, dataStreamFromPattern(env, pattern)).select(new RichPatternSelectFunction<Event, String>() {
			@Override
			public void open(Configuration config) {
				try {
					getRuntimeContext().getMapState(new MapStateDescriptor<>(
	...
	public void testFlatSelectSerializationWithAnonymousClass() throws Exception {
		...
		CEP.dynamicPattern(elements, dataStreamFromPattern(env, Pattern.begin("A"))).flatSelect(
			outputTag,
	...
	private <IN> DataStream<Tuple2<String, Pattern<IN, ?>>> dataStreamFromPattern(StreamExecutionEnvironment env, Pattern<IN, ?> pattern) throws IOException {
		TypeInformation<Tuple2<String, Pattern<IN, ?>>> information = TypeInformation.of(new TypeHint<Tuple2<String, Pattern<IN, ?>>>() {
		});
		TypeSerializer<Tuple2<String, Pattern<IN, ?>>> serializer = information.createSerializer(new ExecutionConfig());
		Tuple2<String, Pattern<IN, ?>> testPattern = Tuple2.of("testPattern", pattern);
		DeleyFromElementSourceFunction<Tuple2<String, Pattern<IN, ?>>> function = new DeleyFromElementSourceFunction<>(serializer, testPattern);
		return env.addSource(function, information);
	}

	public class DeleyFromElementSourceFunction<T> extends FromElementsFunction<T> {

		public DeleyFromElementSourceFunction(TypeSerializer<T> serializer, T... elements) throws IOException {
